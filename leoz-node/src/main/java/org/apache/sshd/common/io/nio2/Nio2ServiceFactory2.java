...
// masc20171102. replicated to be able to properly derive (requires protected access to .group)
// for applying workaround for https://issues.apache.org/jira/browse/SSHD-743

/**
 * @author <a href="mailto:dev@mina.apache.org">Apache MINA SSHD Project</a>
 */
public class Nio2ServiceFactory2 extends AbstractIoServiceFactory {

    protected final AsynchronousChannelGroup group;

    public Nio2ServiceFactory2(FactoryManager factoryManager, ExecutorService service, boolean shutdownOnExit) {
