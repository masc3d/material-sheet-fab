 ...
 */
public interface RouteRepository extends JpaRepository<MstRoute, Long>, QueryDslPredicateExecutor<MstRoute>, RouteRepositoryCustom {
//    @QueryHints(value = {
...
//    }, forCounting = false)
    Iterable<MstRoute> findAll(Predicate predicate);
}
