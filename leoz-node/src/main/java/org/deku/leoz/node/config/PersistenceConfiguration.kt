...
class PersistenceConfiguration {
    ...
    val dataSource: DataSource
        get() {
            ...
            val H2_IN_MEMORY = this.settings.h2.inMemory
            ...
            params.put("DB_CLOSE_ON_EXIT", "FALSE")
...
//        eclipseLinkProperties.setProperty("javax.persistence.schema-generation.create-database-schemas", "true")
    ...
    //region JPA notifications

    @get:Bean
    val jpaNotifications: JpaNotifications
        get() = EclipselinkJpaEmitter
    ...
    @PreDestroy
    fun onDestroy() {
        log.info("Shutting down persistence context [${Application.PROFILE_NODE}]")
