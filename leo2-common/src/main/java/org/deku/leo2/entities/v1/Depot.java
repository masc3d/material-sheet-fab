package org.deku.leo2.entities.v1;
...
public class Depot {
    ...
    @Id
    @Column(name = "DepotNr", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "DepotLevel", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "DepotParent", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "DepotMatchcode", nullable = false, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "LinienNr", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Linienankunft", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Linienabfahrt", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Aktivierungsdatum", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Deaktivierungsdatum", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "IstGueltig", nullable = false, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Firma1", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Firma2", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "LKZ", nullable = true, insertable = true, updatable = true, length = 2)
    ...
    @Basic
    @Column(name = "PLZ", nullable = true, insertable = true, updatable = true, length = 8)
    ...
    @Basic
    @Column(name = "Ort", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Strasse", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "StrNr", nullable = true, insertable = true, updatable = true, length = 10)
    ...
    @Basic
    @Column(name = "LVW", nullable = true, insertable = true, updatable = true)
    public Short getLvw() {
        return lvw;
    }
    ...
    @Basic
    @Column(name = "OVW", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Telefon1", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Telefon2", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Telefax", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Mobil", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Nottelefon1", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Nottelefon2", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Anprechpartner1", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "Anprechpartner2", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "UstID", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "EKStNr", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "BLZ", nullable = true, insertable = true, updatable = true, length = 8)
    ...
    @Basic
    @Column(name = "KtoNr", nullable = true, insertable = true, updatable = true, length = 12)
    ...
    @Basic
    @Column(name = "Bank", nullable = true, insertable = true, updatable = true, length = 25)
    ...
    @Basic
    @Column(name = "KtoInhaber", nullable = true, insertable = true, updatable = true, length = 27)
    ...
    @Basic
    @Column(name = "RName1", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "RName2", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "RLKZ", nullable = true, insertable = true, updatable = true, length = 2)
    ...
    @Basic
    @Column(name = "RPLZ", nullable = true, insertable = true, updatable = true, length = 8)
    ...
    @Basic
    @Column(name = "ROrt", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "RStrasse", nullable = true, insertable = true, updatable = true, length = 50)
    ...
    @Basic
    @Column(name = "RStrNr", nullable = true, insertable = true, updatable = true, length = 10)
    ...
    @Basic
    @Column(name = "Email", nullable = true, insertable = true, updatable = true, length = 75)
    ...
    @Basic
    @Column(name = "Samstag", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Sonntag", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Einzug", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitAnfang", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitEnde", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitAnfangSa", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitEndeSa", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitAnfangSo", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UhrzeitEndeSo", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "ServerNameSMTP", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "ServerNamePOP3", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "IntRoutingLKZ", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "MwStShl", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "MwStPflicht", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "F4F", nullable = true, insertable = true, updatable = true, length = 100)
    ...
    @Basic
    @Column(name = "ExportEmail", nullable = true, insertable = true, updatable = true, length = 245)
    ...
    @Basic
    @Column(name = "ExportFTPServer", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "ExportFTPUser", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "ExportFTPPwd", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "ExportToGLO", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "ExportToXML", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Kondition", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "QualiMail", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "EBSdgDepot", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "EBDepotAD", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "EBGen", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "EBUmvDepot", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "UmRoutung", nullable = true, insertable = true, updatable = true, length = 250)
    ...
    @Basic
    @Column(name = "Kontokorrentnr", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "Zahlungsbedingungen", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "VerbundenesU", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "DebitorNr", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "KreditorNr", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "RgGutschrift", nullable = true, insertable = true, updatable = true, length = 1)
    ...
    @Basic
    @Column(name = "RgRechnung", nullable = true, insertable = true, updatable = true, length = 1)
    ...
    @Basic
    @Column(name = "XMLStammdaten", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Region", nullable = true, insertable = true, updatable = true, length = 10)
    ...
    @Basic
    @Column(name = "Firmenverbund", nullable = true, insertable = true, updatable = true, length = 100)
    ...
    @Basic
    @Column(name = "Qualitaet", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "SonntagsLinientyp", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Com_code", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "eMail_pas", nullable = true, insertable = true, updatable = true, length = 100)
    ...
    @Basic
    @Column(name = "XML_ACN", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "webemail", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "webadresse", nullable = true, insertable = true, updatable = true, length = 255)
    ...
    @Basic
    @Column(name = "PA_XML", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "PA_PDF", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "ZahlungsbedingungenR", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "EASYOk", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "VofiPrz", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "FELang", nullable = true, insertable = true, updatable = true, length = 5)
    ...
    @Basic
    @Column(name = "MentorDepotNr", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "TRZProz", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "NNOk", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "COD1", nullable = true, insertable = true, updatable = true, length = 5)
    ...
    @Basic
    @Column(name = "XLSAuftragOK", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "HanReg", nullable = true, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "Coloader", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "AbrechDepot", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "LadehilfeWas", nullable = true, insertable = true, updatable = true, length = 100)
    ...
    @Basic
    @Column(name = "LadehilfeKg", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "LadehilfeAb", nullable = true, insertable = true, updatable = true, length = 5)
    ...
    @Basic
    @Column(name = "LadehilfeLinie", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "PA_Druck", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "RUP", nullable = true, insertable = true, updatable = true, length = 15)
    ...
    @Basic
    @Column(name = "MasterVertrag", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "Strang", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "MasterDepot", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "WebshopInit", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "MultiBag", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "BagKontingent", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "BagBemerkung", nullable = true, insertable = true, updatable = true, length = 15)
    ...
    @Basic
    @Column(name = "KonditionAbD", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "KonditionLD", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "BagCo", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "StrangDatum", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "StrangZ", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "StrangOrder", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "smspwd", nullable = true, insertable = true, updatable = true, length = 20)
    ...
    @Basic
    @Column(name = "ValOk", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "maxValwert", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "maxHoeherhaftung", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "maxWarenwert", nullable = true, insertable = true, updatable = true, precision = 0)
    ...
    @Basic
    @Column(name = "SAPCostCenter", nullable = true, insertable = true, updatable = true, length = 10)
    ...
    @Basic
    @Column(name = "AdHocKondiDepot", nullable = true, insertable = true, updatable = true)
