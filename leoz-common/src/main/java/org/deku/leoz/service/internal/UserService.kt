...
interface UserService {
    ...
    data class User(
            ...
            @get:ApiModelProperty(example = "2019-03-16T17:00:00.000Z", required = false, value = "Date this account is supposed to expire")
            ...
            @get:ApiModelProperty(example = "2019-03-16T17:00:00.000Z", required = false, value = "Date this accounts password is supposed to expire")
