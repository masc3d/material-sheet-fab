...
enum class Reason(val id: Int, val oldValue: Int = 0) {
    NORMAL(id = 0, oldValue = 0),
    Empfaenger_nicht_angetroffen(id = 500, oldValue = 10),
    Exportstation_Informiert(id = 501, oldValue = 11),
    Annahme_verweigert(id = 503, oldValue = 12),
    //Annahme_verweigert(id = 502, oldValue = 13),
    Urlaub_Empfaenger(id = 504, oldValue = 14),
    Kunde_wuenscht_Selbstabholung(id = 505, oldValue = 15),
    Adresse_falsch(id = 506, oldValue = 16),
    //Adresse_falsch-SDG_an_Lager(id = 506, oldValue = 17),
    //Adresse_falsch(id = 507, oldValue = 18),
    //Adresse_falsch(id = 506, oldValue = 19),
    Empfaenger_verzogen(id = 509, oldValue = 20),
    Empfaenger_unbekannt(id = 509, oldValue = 21),
    Packstueck_fehlt(id = 512, oldValue = 30),
    Packstueck_beschaedigt(id = 513, oldValue = 31),
    Sdg_geht_Retoure(id = 533, oldValue = 32),
    SMS_nicht_zugestellt(id = 500, oldValue = 33),
    Fehlrouting(id = 510, oldValue = 40),
    //Fehlrouting(id = 510, oldValue = 41),
    Fehlverladung(id = 511, oldValue = 42),
    //Fehlverladung(id = 511, oldValue = 43),
    Storno_keine_Zustellung(id = 514, oldValue = 50),
    Tausch_Pruefcode_falsch(id = 516, oldValue = 60),
    Tauschobjekt_defekt(id = 517, oldValue = 61),
    Tauschobjekt_falsch(id = 518, oldValue = 62),
    Unterschrift_verweigert(id = 519, oldValue = 63),
    Freischaltung(id = 520, oldValue = 64),
    Kunde_will_kann_nicht_bezahlen(id = 521, oldValue = 65),
    Sendung_wurde_ins_Lager_gelegt(id = 522, oldValue = 66),
    neuer_Termin_vereinbart(id = 523, oldValue = 67),
    Ident_Dokument_nicht_vorhanden(id = 524, oldValue = 68),
    Zollbeschau(id = 525, oldValue = 70),
    Zollgebuehr_soll_Empfaenger_zahlen(id = 526, oldValue = 71),
    aufgrund_von_Verkehrsproblemen(id = 527, oldValue = 72),
    Kapazitaetsmangel_Nahverkehr(id = 528, oldValue = 73),
    Austauschgeraet_nicht_Versandfertig(id = 529, oldValue = 74),
    da_keine_Zahlungsmittel_vorraetig(id = 530, oldValue = 75),
    PIN__IMEI_fehlerhaft(id = 532, oldValue = 77)
}