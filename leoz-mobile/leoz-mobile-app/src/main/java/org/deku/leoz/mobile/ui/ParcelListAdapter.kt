...
class ParcelListAdapter(val context: Context, val data: List<Order.Parcel>, val rootViewGroup: ViewGroup? = null): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        (vi.findViewById(R.id.uxParcelReference) as TextView).text = data[position].labelReference
        (vi.findViewById(R.id.uxParcelStatus) as ImageView).setImageDrawable(context.resources.getDrawable(R.drawable.ic_cancel_black))
