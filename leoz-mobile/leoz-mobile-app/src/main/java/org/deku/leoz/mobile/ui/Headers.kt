...
object Headers {
    ...
    val street: Drawable
        get() = this.createHeaderDrawable(R.drawable.img_street_1, 0.8)

    val cash: Drawable
        get() = this.createHeaderDrawable(R.drawable.img_money, 0.3)

    val parcels: Drawable
        get() = this.createHeaderDrawable(R.drawable.img_parcels_1, 0.3)
}