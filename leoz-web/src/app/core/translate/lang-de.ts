export const LANG_DE_TRANS = {
  ...
  'record-order': 'Auftragserfassung',
  'lists': 'Listen',
  'footer': 'Fussbereich',
  'dispo': 'Dispo',
  'shipmentcockpit': 'Sendungscockpit',
  'scans': 'Scans',
  'importscan': 'Importscan',
  'driver-assignment': 'Fahrerzuordnung',
  'i-point': 'I-Punkt',
  'importdispo': 'Importdispo',
  'tourplanning': 'Tourplanung',
  'driver': 'Driver',
  'deliverydispo': 'Zustelldispo',
  'deliveryscan': 'Zustellscan',
  'shipmentinfo': 'Sendungsinfo',
