export const LANG_DE_TRANS = {
  ...
  'pwdChangeSuccess': 'Ihr Passwort wurde erfolgreich geändert.',
  'pwdChangeFailure': 'Ihr Passwort konnte nicht geändert werden.',
  'oldPwd': 'altes Passwort',
  'newPwd': 'neues Passwort',
  'newPwdRepeat': 'neues Passwort wiederholen',
  // menu
  'home': 'Startseite',
  'lists': 'Listen',
  'footer': 'Fussbereich',
  ...
  'Parcel not found': 'Paketnummer nicht gefunden',
  'BagId wrong check digit': 'BagId falsche Prüfziffer',
  'BagId not found': 'BagId nicht gefunden',
  'invalid label': 'Ungültiges Label',
  'BagId not found in move-state': 'BagId nicht in Bewegungstabelle',
  'LastDepot-Station mismatch': 'BagId gehört nicht zu Ihrer Station',
  'BagId without lastStation': 'BagId ohne Stationszuordnung',
  'invalid backseal': 'Ungültige Rückplombe',
  'BagId not valid': 'BagId ungültig',
  'Parcel already scanned': 'Paket bereits gescannt',
  ...
  'completeProcessing': 'Bearbeitung abschliessen',
  ...
  'baglist': 'Bagliste',
  'bagCountSingleMsg': 'Ihr Bag-Bestand überschreitet Ihr Kontingent.' + '<br>' +
  'Bitte senden Sie zur Entlastung 1 Bag zurück.',
  'bagCountMsgfield': 'Ihr Bag-Bestand überschreitet Ihr Kontingent.' + '<br>' +
  'Bitte senden Sie zur Entlastung #BAGCOUNT# Bags zurück.',
  'infoMsgfield': 'Belegscanfeld öffnen mit F2.' + '<br>' +
  'Felder leeren mit F3.',
  ...
  'inboundscanHeader': 'Inbound-Scan',
  'inboundscanTourLegend': 'Tour',
  'tourDisplayFilter1': 'Stammdaten',
  'tourDisplayFilter2': 'Disposition',
  'tourDisplayFilter3': 'Optimierung',
  'myWorkspaceTabHeader': 'My Workspace',
  'locationTabHeader': 'Station',
  'inboundTabHeader': 'Inbound',
  'inboundStatus': 'Status',
  'inboundPackNo': 'Packstück-Nr.',
  'inboundTour': 'Tour',
  'inboundZip': 'PLZ',
  'inboundWeight': 'Gewicht',
  'inboundDimensions': 'Maße',
  'packDetailsDeliveryAddress': 'Zustelladresse',
  'packDetailsPickupAddress': 'Absenderadresse',
  'weightCorrections': 'Auftrag zur Gewichtskorrektur',
  'saveAndSendMail': 'speichern und E-Mail versenden',
  'parcelMissingHeader': 'Packstück fehlt',
  'parcelMissingConfirmMessage': 'Sie sind im Begriff diese Packstück als fehlend zu markieren!',
  'confirm': 'Bestätigen',
  'parcelDamagedHeader': 'Packstück beschädigt',
  'parcelDamagedConfirmMessage': 'Sie sind im Begriff diese Packstück als beschädigt zu markieren!',
  // deliveryscan form
  ...
  'optimizeTodayAndFuture': 'Tourstart jetzt',
  ...
  'assigned stations': 'zugeordnete Stationen',
