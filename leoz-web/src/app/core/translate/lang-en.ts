export const LANG_EN_TRANS = {
  ...
  'pwdChangeSuccess': 'Your password has been changed successfully.',
  'pwdChangeFailure': 'Your Passwort could not have been changed',
  'oldPwd': 'old password',
  'newPwd': 'new password',
  ...
  'baglist': 'Baglist',
  'bagCountSingleMsg': 'Your bag inventory exceeds your quota.' + '<br>' +
  'Please return 1 bag for relief.',
  'bagCountMsgfield': 'Your bag inventory exceeds your quota.' + '<br>' +
  'Please return #BAGCOUNT# bags for relief.',
  'infoMsgfield': 'Open the scanning panel with F2.' + '<br>' +
  'Clear fields with F3.',
  ...
  'inboundscanHeader': 'Inboundscan',
  'inboundscanTourLegend': 'Tour',
  'tourDisplayFilter1': 'base data',
  'tourDisplayFilter2': 'dispo',
  'tourDisplayFilter3': 'optimization',
  'myWorkspaceTabHeader': 'My Workspace',
  'locationTabHeader': 'Station',
  'inboundTabHeader': 'Inbound',
  'inboundStatus': 'State',
  'inboundPackNo': 'PackNo',
  'inboundTour': 'Tour',
  'inboundZip': 'ZIP',
  'inboundWeight': 'Weight',
  'inboundDimensions': 'Dimensions',
  'packDetailsDeliveryAddress': 'Delivery Address',
  'packDetailsPickupAddress': 'Pickup Address',
  'weightCorrections': 'Request for weight corrections',
  'saveAndSendMail': 'save and send email',
  'parcelMissingHeader': 'Parcel is missing',
  'parcelMissingConfirmMessage': 'You are going to mark this parcel as missing!',
  'confirm': 'Confirm',
  'parcelDamagedHeader': 'Parcel is damaged',
  'parcelDamagedConfirmMessage': 'You are going to mark this parcel as damaged!',
  // deliveryscan form
  ...
  'optimizeTodayAndFuture': 'Tourstart now',
  ...
  // export messages
  'Loadinglist - wrong check digit': 'Loadinglist - wrong check digit',
  'Loadinglist not valid': 'Loadinglist not valid',
  'Loadinglist changed': 'Loadinglist changed',
  'Loadinglist not of Bag-Type': 'Loadinglist not of Bag-Type',
  'Loadinglist used for multiple bags': 'Loadinglist used for multiple bags',
  'Loadinglist already used for another bag': 'Loadinglist already used for another bag',
  'Valuables not allowed': 'Valuables not allowed',
  'Valuables not allowed without bag': 'Valuables not allowed without bag',
  'Parcel already scanned': 'Parcel already scanned',
  'Parcel not found': 'Parcel not found',
  'Parcel delivered': 'Parcel delivered',
  'Parcel deleted': 'Parcel deleted',
  'More parcels found to this cReference': 'More parcels found to this cReference',
  'Order not found': 'Order not found',
  'No ONS': 'No ONS',
  'Station dismatch': 'Station dismatch',
  'No orders found': 'No orders found',
  'No parcels found': 'No parcels found',
  'No parcels found for this station': 'No parcels found for this station',
  'No parcels found for this list': 'No parcels found for this list',
  'BagId wrong check digit': 'BagId wrong check digit',
  'BagId not valid': 'BagId not valid',
  'BagId not found': 'BagId not found',
  'BagId without lastStation': 'BagId without lastStation',
  'BagId not found in move-state': 'BagId not found in move-state',
  'BagId found - no bagback-unit found': 'BagId found - no bagback-unit found',
  'BagId found - no bagback-order found': 'BagId found - no bagback-order found',
  'BagId found - bagback-order without depotnrabd': 'BagId found - bagback-order without depotnrabd',
  'BagId found - bagback-order station mismatch depotnrabd': 'BagId found - bagback-order station mismatch depotnrabd',
  'BagId found - bag already exported': 'BagId found - bag already exported',
  'BagId found - bag already closed - try to reopen': 'BagId found - bag already closed - try to reopen',
  'BagId found - already open': 'BagId found - already open',
  'Bag-UnitNo wrong check digit': 'Bag-UnitNo wrong check digit',
  'Bag-UnitNo not valid': 'Bag-UnitNo not valid',
  'Bag-BackUnitNo dismatch': 'Bag-BackUnitNo dismatch',
  'BagBackUnitNo used for multiple loadinglists': 'BagBackUnitNo used for multiple loadinglists',
  'BagBackUnitNo already used for another loadinglist': 'BagBackUnitNo already used for another loadinglist',
  'Red seal - wrong check digit': 'Red seal - wrong check digit',
  'Red seal not valid': 'Red seal not valid',
  'Red seal not found': 'Red seal not found',
  'LastDepot-Station mismatch': 'LastDepot-Station mismatch',
  'Sealstatus-problem': 'Sealstatus-problem',
  'SealNo already in use': 'SealNo already in use',
  'Seal number mismatch': 'Seal number mismatch',
  'Yellow seal number - wrong check digit': 'Yellow seal number - wrong check digit',
  'Yellow seal number not valid': 'Yellow seal number not valid',
  'No seal number in bag': 'No seal number in bag',
  'Weight > max': 'Weight > max',
  'Invalid senddate': 'Invalid senddate',
  'invalid label': 'Invalid Label',
  'invalid backseal': 'Invalid backseal'
};
