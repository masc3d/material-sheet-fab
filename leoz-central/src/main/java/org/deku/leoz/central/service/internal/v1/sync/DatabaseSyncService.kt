package org.deku.leoz.central.service.internal.v1.sync
...
import org.deku.leoz.central.data.jooq.tables.*
import org.deku.leoz.central.data.jooq.tables.MstBundleVersion
import org.deku.leoz.central.data.jooq.tables.MstCountry
import org.deku.leoz.central.data.jooq.tables.MstRoute
import org.deku.leoz.central.data.jooq.tables.MstSector
import org.deku.leoz.central.data.jooq.tables.MstStation
import org.deku.leoz.central.data.jooq.tables.MstStationSector
...
constructor(
    ...
    companion object {
         ...
         */
        private fun convert(ds: MstBundleVersionRecord): org.deku.leoz.node.data.jpa.MstBundleVersion {
            val s = org.deku.leoz.node.data.jpa.MstBundleVersion()
         ...
         * @return
         */
        private fun convert(ds: MstStationRecord): org.deku.leoz.node.data.jpa.MstStation {
            val s = org.deku.leoz.node.data.jpa.MstStation()
         ...
         * @return
         */
        private fun convert(cr: MstCountryRecord): org.deku.leoz.node.data.jpa.MstCountry {
            val c = org.deku.leoz.node.data.jpa.MstCountry()
         ...
         * @return
         */
        private fun convert(cr: MstSectorRecord): org.deku.leoz.node.data.jpa.MstSector {
            val d = org.deku.leoz.node.data.jpa.MstSector()
         ...
         * @return
         */
        private fun convert(sr: MstRouteRecord): org.deku.leoz.node.data.jpa.MstRoute {
            val d = org.deku.leoz.node.data.jpa.MstRoute()
         ...
         * @return
         */
        private fun convert(ss: MstStationSectorRecord): org.deku.leoz.node.data.jpa.MstStationSector {
            val s = org.deku.leoz.node.data.jpa.MstStationSector()
            s.id = ss.id.toLong()
    ...
    @Synchronized open fun sync(clean: Boolean) {
        ...
        this.updateEntities<MstBundleVersionRecord, org.deku.leoz.node.data.jpa.MstBundleVersion>(
                Tables.MST_BUNDLE_VERSION,
                MstBundleVersion.MST_BUNDLE_VERSION.SYNC_ID,
        ...
        this.updateEntities<MstStationRecord, org.deku.leoz.node.data.jpa.MstStation>(
                Tables.MST_STATION,
