...
//            }
            ...
            recordMessages.eventValue = if (parcelServiceSettings.enableMessageEventCorrection && it.event == 107 && it.reason == 0 && (message.deliveredInfo != null || message.postboxDeliveryInfo != null)) 106 else it.event
            ...
            val eventId = if (parcelServiceSettings.enableMessageEventCorrection && it.event == 107 && it.reason == 0 && (message.deliveredInfo != null || message.postboxDeliveryInfo != null)) 106 else it.event
