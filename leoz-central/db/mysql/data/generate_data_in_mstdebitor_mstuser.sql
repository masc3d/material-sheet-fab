...
DELETE FROM mst_debitor_station;
INSERT INTO mst_debitor_station (station_id, debitor_id, activ_from, activ_to)
  SELECT
    tbldepotliste.ID,
...
DELETE FROM mst_user WHERE email = 'user@deku.org' OR email = 'dev@leoz';
