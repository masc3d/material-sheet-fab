...
/*
-- Query: select * from trn_node_geoposition
LIMIT 0, 1000

-- Date: 2017-06-01 11:02
*/
INSERT INTO `trn_node_geoposition` (`position_id`, `user_id`, `node_id`, `ts_created`, `ts_updated`, `latitude`, `longitude`, `position_datetime`, `speed`, `bearing`, `altitude`, `accuracy`)
VALUES
...
VALUES
  (1007, 1, NULL, '2017-06-01 10:47:11', '0000-00-00 00:00:00', 49.83872, 9.18346, '2017-05-29 09:49:27', 48.4, NULL,
         NULL, NULL);
/*
-- Query: select * from trn_node_geoposition where position_id>1000
LIMIT 0, 1000
...
VALUES
  (2492, 2, NULL, '2017-06-01 11:04:40', '0000-00-00 00:00:00', 49.74538, 9.2356, '2017-06-01 09:48:26', 93.2, NULL,
         NULL, NULL);
/*
-- Query: select * from trn_node_geoposition where position_id>2492
LIMIT 0, 5000
